        ...
        <v-layout align-center justify-center >
            <v-flex xs3>
                <v-form ref="form" v-model="valid" lazy-validation>
                    <v-text-field v-model="queryForm.username" :counter="15" :rules="nameRules" :label="$t('user.username')" required></v-text-field>
                    ...
                    <v-btn :disabled="!valid" color="info" @click="register" block>
                        {{$t('register.query')}}
                    </v-btn>
